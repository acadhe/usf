...
<link rel="stylesheet" type="text/css" href="<?php echo e(asset('frontend/css/slick-theme-ucp.css')); ?>"/>
...
<link rel="apple-touch-icon" sizes="180x180" href="<?php echo e(asset('frontend/img/faviconss/apple-touch-icon.png')); ?>">
<link rel="icon" type="image/png" href="<?php echo e(asset('frontend/img/faviconss/favicon-32x32.png')); ?>" sizes="32x32">
<link rel="icon" type="image/png" href="<?php echo e(asset('frontend/img/faviconss/favicon-16x16.png')); ?>" sizes="16x16">
<link rel="manifest" href="<?php echo e(asset('frontend/img/faviconss/manifest.json')); ?>">
<link rel="mask-icon" href="<?php echo e(asset('frontend/img/faviconss/safari-pinned-tab.svg')); ?>" color="#5bbad5">
...
<?php $__env->startSection('content'); ?>
									...
									<div class="row">
										<div class="col s12 m6">
											<div id="wrapper-usf-logo">
												<img src="<?php echo e(asset('frontend/img/header.png')); ?>" class="img-responsive" alt="USF Logo" id="usf-logo">
											</div>
										</div>
										<div class="col s12 m6">
											<div id="wrapper-usf-reg">
												...
												<?php /* <a href="http://bit.ly/RegistrasiUSF2016" class="btn btn-usf" target="_blank">JOIN AS A PARTICIPANT</a> */ ?>
	...
	<div class="hide-on-small-only" id="bg-usf">
		<img src="<?php echo e(asset('frontend/img/bg_21.png')); ?>" alt="mic">
	</div>
											...
											<ul>
												<li>
													<div class="choice-round">
														<?php /* <a href="http://bit.ly/OrganiserUSF2016" target="_blank"> */ ?>
												...
												<li>
													<div class="choice-round">
														<?php /* <a href="http://bit.ly/VolunteerUSF2016" target="_blank"> */ ?>
												...
												<li>
													<div class="choice-round">
														<?php /* <a href="http://bit.ly/BoothUSF2016" target="_blank"> */ ?>
												...
												<li>
													<div class="choice-round">
														<?php /* <a href="http://bit.ly/KontributorUSF2016" target="_blank"> */ ?>
	...
	<?php /* <div id="bg-participate">
		<img src="<?php echo e(asset('frontend/img/bg_11.png')); ?>" alt="mic">
	</div> */ ?>

<?php /* 	<section class="scrollspy" id="schedule-soon">
...
<?php /*    <section class="scrollspy" id="speakers">
		<div class="row">
			<div class="container cards" id="wrapper-speakers">
				<div class="row">
					<div class="col m2" id="speakers-badge">
						<img src="<?php echo e(asset('frontend/img/ic_speaker_2.svg')); ?>" alt="USF Speakers" class="ic">
					</div>
													...
													<div class="wrapper-card-speakers">
														<div>
															<div class="img-carousel">
																<a href=""><img src="<?php echo e(asset('frontend/img/pp1.png')); ?>" alt="" class="responsive-img circle"></a>
															</div>
											...
											<div class="card">
												<div class="card-content">
													<div class="wrapper-card-speakers">
														<div>
															<div class="img-carousel">
																<a href=""><img src="<?php echo e(asset('frontend/img/pp2.jpg')); ?>" alt="" class="responsive-img circle"></a>
															</div>
															<div class="info-carousel">
																<p>Vasilenka</p>
																<p>CCO Meridian.id</p>
											...
											<div class="card">
												<div class="card-content">
													<div class="wrapper-card-speakers">
														<div>
															<div class="img-carousel">
																<a href=""><img src="<?php echo e(asset('frontend/img/pp3.jpg')); ?>" alt="" class="responsive-img circle"></a>
															</div>
															<div class="info-carousel">
																<p>Vasilenka</p>
																<p>CCO Meridian.id</p>
											...
											<div class="card">
												<div class="card-content">
													<div class="wrapper-card-speakers">
														<div>
															<div class="img-carousel">
																<a href=""><img src="<?php echo e(asset('frontend/img/pp4.jpg')); ?>" alt="" class="responsive-img circle"></a>
															</div>
															<div class="info-carousel">
																<p>Vasilenka</p>
																<p>CCO Meridian.id</p>
											...
											<div class="card">
												<div class="card-content">
													<div class="wrapper-card-speakers">
														<div>
															<div class="img-carousel">
																<a href=""><img src="<?php echo e(asset('frontend/img/pp5.jpg')); ?>" alt="" class="responsive-img circle"></a>
															</div>
															<div class="info-carousel">
																<p>Vasilenka</p>
																<p>CCO Meridian.id</p>
											...
											<div class="card">
												<div class="card-content">
													<div class="wrapper-card-speakers">
														<div>
															<div class="img-carousel">
																<a href=""><img src="<?php echo e(asset('frontend/img/pp6.png')); ?>" alt="" class="responsive-img circle"></a>
															</div>
															<div class="info-carousel">
																<p>Vasilenka</p>
																<p>CCO Meridian.id</p>
											...
											<div class="card">
												<div class="card-content">
													<div class="wrapper-card-speakers">
														<div>
															<div class="img-carousel">
																<a href=""><img src="<?php echo e(asset('frontend/img/pp7.jpg')); ?>" alt="" class="responsive-img circle"></a>
															</div>
															<div class="info-carousel">
																<p>Vasilenka</p>
																<p>CCO Meridian.id</p>
	...
	<?php /* <div id="bg-mic">
		<img src="<?php echo e(asset('frontend/img/img_mic.svg')); ?>" alt="mic" class="ic">
	</div> */ ?>

<?php /*    <section class="scrollspy" id="discussions">
		<div class="row">
			<div class="container cards" id="wrapper-discussions">
				<div class="row">
					...
					<div class="col m3" id="discussions-badge">
						<img src="<?php echo e(asset('frontend/img/ic_discussion.svg')); ?>" alt="USF Speakers" class="ic">
					</div>
				</div>
				<div class="row">
					<div class="col m12">
										...
										<div class="row center-card">
											<div class="card">
												<div class="card-image">
													<img src="<?php echo e(asset('frontend/img/post.jpg')); ?>" alt="">
												</div>
												<div class="card-content">
													<p>Vasilenka</p>
	...
	<section class="scrollspy" id="schedule">
		<div class="container" id="wrapper-schedule">
			<?php /* <div class="row">
				<div class="col m4">
					<img src="<?php echo e(asset('frontend/img/ic_schedule.svg')); ?>" alt="USF Speakers" class="ic">
				</div>
			</div> */ ?>
			<div class="row">
				<div class="col s12 m7" id="schedule-timeline">
					...
					<?php /* <div class="wrapper-btn-expand">
				...
				<div class="col s12 m5 valign-wrapper" id="schedule-info">
					<div class="valign">
						<p>Saturday</p>
						<p>December 3<sup>rd</sup>, 2016</p>
						<?php /* <p>All day long, awesome events awaits for you.</p> */ ?>
	...
	<section class="scrollspy" id="venue">
		<?php /* <div class="container" id="wrapper-venue">
			<div class="row">
				...
				<div class="col m4" id="venue-logo">
					<img src="<?php echo e(asset('frontend/img/ic_venue.svg')); ?>" alt="USF Venue" class="ic">
				</div>
			</div>
		</div> */ ?>
													...
													<div class="grayscale">
														<div>
															<a href="http://bit.ly/usf_report" target="_blank">
																<figure>
																	<img src="<?php echo e(asset('frontend/img/archive_report.png')); ?>" alt="USF Logo" id="usf-logo">
																	<span>
																		event report 2015
																	</span>
																</figure>
													...
													<div class="grayscale">
														<div>
															<a href="http://bit.ly/usf_photos" target="_blank">
																<figure>
																	<img src="<?php echo e(asset('frontend/img/archive_foto.png')); ?>" alt="USF Logo" id="usf-logo">
																	<span>
																		Photo gallery
																	</span>
																</figure>
													...
													<div class="grayscale">
														<div>
															<a href="http://bit.ly/usf_video" target="_blank">
																<figure>
																	<img src="<?php echo e(asset('frontend/img/archive_video.png')); ?>" alt="USF Logo" id="usf-logo">
																	<span>
																		Video
																	</span>
																</figure>
							...
							<div class="col s12 m12">
								<div id="wrapper-org-part-choice">
									<div class="row">
										<ul>
											<li>
												<img src="<?php echo e(asset('frontend/img/logo/1.png')); ?>" alt="" class="responsive-img materialboxed" data-caption="Kota Kita" width="250">
											</li>
											<li>
												<img src="<?php echo e(asset('frontend/img/logo/2.png')); ?>" alt="" class="responsive-img materialboxed" data-caption="Kota Semarang" width="250">
											</li>
											<li>
												<img src="<?php echo e(asset('frontend/img/logo/3.png')); ?>" alt="" class="responsive-img materialboxed" data-caption="Diponegoro University" width="250">
											</li>
											<li>
												<img src="<?php echo e(asset('frontend/img/logo/4.png')); ?>" alt="" class="responsive-img materialboxed" data-caption="P5 Universitas Diponegoro" width="250">
											</li>
											<li>
												<img src="<?php echo e(asset('frontend/img/logo/5.png')); ?>" alt="" class="responsive-img materialboxed" data-caption="IUCCE" width="250">
											</li>
											<li>
												<img src="<?php echo e(asset('frontend/img/logo/6.png')); ?>" alt="" class="responsive-img materialboxed" data-caption="Hysteria" width="250">
											</li>
											<li>
												<img src="<?php echo e(asset('frontend/img/logo/7.png')); ?>" alt="" class="responsive-img materialboxed" data-caption="Peka Kota" width="250">
											</li>
										<?php /* </ul>
									</div>
									<div class="row">
										<ul> */ ?>
											<li>
												<img src="<?php echo e(asset('frontend/img/logo/8.png')); ?>" alt="" class="responsive-img materialboxed" data-caption="Komunitas Sahabat Difabel" width="250">
											</li>
											<li>
												<img src="<?php echo e(asset('frontend/img/logo/9.png')); ?>" alt="" class="responsive-img materialboxed" data-caption="ITDP" width="250">
											</li>
											<li>
												<img src="<?php echo e(asset('frontend/img/logo/10.png')); ?>" alt="" class="responsive-img materialboxed" data-caption="Program Peduli" width="250">
											</li>
											<li>
												<img src="<?php echo e(asset('frontend/img/logo/11.png')); ?>" alt="" class="responsive-img materialboxed" data-caption="ASB" width="250">
											</li>
											<li>
												<img src="<?php echo e(asset('frontend/img/logo/12.png')); ?>" alt="" class="responsive-img materialboxed" data-caption="Mercy Corps Indonesia" width="250">
											</li>
											<li>
												<img src="<?php echo e(asset('frontend/img/logo/13.png')); ?>" alt="" class="responsive-img materialboxed" data-caption="ACCRN" width="250">
											</li>
											<li>
												<img src="<?php echo e(asset('frontend/img/logo/14.png')); ?>" alt="" class="responsive-img materialboxed" data-caption="IYMM" width="250">
											</li>
										<?php /* </ul>
									</div>
									<div class="row">
										<ul> */ ?>
											<li>
												<img src="<?php echo e(asset('frontend/img/logo/15.png')); ?>" alt="" class="responsive-img materialboxed" data-caption="ARI National University of Singapore" width="250">
											</li>
											<li>
												<img src="<?php echo e(asset('frontend/img/logo/16.png')); ?>" alt="" class="responsive-img materialboxed" data-caption="UNESCO Jakarta" width="250">
											</li>
											<li>
												<img src="<?php echo e(asset('frontend/img/logo/17.png')); ?>" alt="" class="responsive-img materialboxed" data-caption="UBAYA" width="250">
											</li>
											<li>
												<img src="<?php echo e(asset('frontend/img/logo/18.png')); ?>" alt="" class="responsive-img materialboxed" data-caption="Charter for Compassion" width="250">
											</li>
											<li>
												<img src="<?php echo e(asset('frontend/img/logo/19.png')); ?>" alt="" class="responsive-img materialboxed" data-caption="Disaster Goverment Asia" width="250">
											</li>
											<li>
												<img src="<?php echo e(asset('frontend/img/logo/20.png')); ?>" alt="" class="responsive-img materialboxed" data-caption="UrbanLab" width="250">
											</li>
											<li>
												<img src="<?php echo e(asset('frontend/img/logo/21.png')); ?>" alt="" class="responsive-img materialboxed" data-caption="Generation Foundation" width="250">
											</li>
										<?php /* </ul>
									</div>
									<div class="row">
										<ul> */ ?>
											<li>
												<img src="<?php echo e(asset('frontend/img/logo/22.png')); ?>" alt="" class="responsive-img materialboxed" data-caption="" width="250" data-caption="Kampungnesia" width="250">
											</li>
											<li>
												<img src="<?php echo e(asset('frontend/img/logo/23.png')); ?>" alt="" class="responsive-img materialboxed" data-caption="Subcylist" width="250">
											</li>
											<li>
												<img src="<?php echo e(asset('frontend/img/logo/24.png')); ?>" alt="" class="responsive-img materialboxed" data-caption="Tanah Indie" width="250">
											</li>
											<li>
												<img src="<?php echo e(asset('frontend/img/logo/25.png')); ?>" alt="" class="responsive-img materialboxed" data-caption="Peta Bencana" width="250">
											</li>
											<li>
												<img src="<?php echo e(asset('frontend/img/logo/26.png')); ?>" alt="" class="responsive-img materialboxed" data-caption="GPR2C" width="250">
											</li>
											<li>
												<img src="<?php echo e(asset('frontend/img/logo/27.png')); ?>" alt="" class="responsive-img materialboxed" data-caption="Subcyclist" width="250">
											</li>
											<li>
												<img src="<?php echo e(asset('frontend/img/logo/28.png')); ?>" alt="" class="responsive-img materialboxed" data-caption="Tanah Indie" width="250">
											</li>
										<?php /* </ul>
									</div>
									<div class="row">
										<ul> */ ?>
											<li>
												<img src="<?php echo e(asset('frontend/img/logo/29.png')); ?>" alt="" class="responsive-img materialboxed" data-caption="Indonesian Heritage Inventory"" width="250">
											</li>
											<li>
												<img src="<?php echo e(asset('frontend/img/logo/30.png')); ?>" alt="" class="responsive-img materialboxed" data-caption="Ternate Heritage Society"" width="250">
											</li>
											<li>
												<img src="<?php echo e(asset('frontend/img/logo/31.png')); ?>" alt="" class="responsive-img materialboxed" data-caption="Rumah Kartini Jepara" width="250">
											</li>
											<li>
												<img src="<?php echo e(asset('frontend/img/logo/32.png')); ?>" alt="" class="responsive-img materialboxed" data-caption="Warga Berdaya - Yogyakarta" width="250">
											</li>
											<li>
												<img src="<?php echo e(asset('frontend/img/logo/33.png')); ?>" alt="" class="responsive-img materialboxed" data-caption="Lasem Heritage Society" width="250">
											</li>
											<li>
												<img src="<?php echo e(asset('frontend/img/logo/34.png')); ?>" alt="" class="responsive-img materialboxed" data-caption="Kampoeng Bogor" width="250">
											</li>
											<li>
												<img src="<?php echo e(asset('frontend/img/logo/35.png')); ?>" alt="" class="responsive-img materialboxed" data-caption="Kota Toea Magelang" width="250">
											</li>
										</ul>
									</div>
								</div>
					...
					<ul id="social-icons">
						<li>
							<a href="https://www.facebook.com/urban.social.forum" id="fb" target="_blank">
								<img src="<?php echo e(asset('frontend/img/facebook.svg')); ?>" alt="phone" class="ic">
							</a>
						</li>
						<li>
							<a href="https://www.twitter.com/urban_forum" id="tw" target="_blank">
								<img src="<?php echo e(asset('frontend/img/twitter.svg')); ?>" alt="phone" class="ic">
							</a>
						</li>
						<li>
							<a href="https://www.instagram.com/urbansocialforum" id="insta" target="_blank">
								<img src="<?php echo e(asset('frontend/img/igs.png')); ?>" alt="phone">
							</a>
						</li>
					</ul>
				</div>
...
<?php /* 	<section class="scrollspy" id="contact">
		<div id="bg-phone">
			<img src="<?php echo e(asset('frontend/img/img_phone.svg')); ?>" alt="phone" class="ic">
		</div>
		<div class="container" id="wrapper-contact">
			<div class="row">
				<div class="col m12" id="contact-logo">
					<img src="<?php echo e(asset('frontend/img/ic_contact.svg')); ?>" alt="USF Speakers" class="ic">
				</div>
			</div>
			<div class="row">
		...
		<div class="container" id="wrapper-partner">
			<div class="row">
				<div class="col m12" id="partner-logo">
					<img src="<?php echo e(asset('frontend/img/ic_partner.svg')); ?>" alt="USF Speakers" class="ic">
				</div>
			</div>
			<div class="row" id="partner-img">
				<ul>
					<li>
						<img src="<?php echo e(asset('frontend/img/logo/')); ?>" alt="" class="responsive-img">
					</li>
					<li>
						<img src="<?php echo e(asset('frontend/img/logo/')); ?>" alt="" class="responsive-img">
					</li>
