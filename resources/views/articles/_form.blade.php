...
<div class="container" id="wrapper-form-create">
	<div class="row">
		<div class="col m12" id="form-post">
			<textarea name="title" class="post-judul materialize-textarea" id="" value="{{old('title',$article->title)}}" placeholder="Title">{{$article->title}}</textarea>
			...
			<div class="activator">
				@if($article->header_image_url == null)
					<img src="{{asset('frontend/img/rectangle-9.png')}}" class="responsive-img" id="headerimg-preview">
					<div class="up-btn">
						<div class="btn">
				...
				@else
					<img src='{{$article->header_image_url}}' class="responsive-img" id="headerimg-preview">
				...
				@endif
				<p class="error-message">{{$errors->first('headerimg')}}</p>
			</div>
			...
			{{--input social media connection to be submitted. the value will be gotten from the navbar using jquery--}}
		...
		tinymce.init({
		  ...
		  file_picker_callback: function(callback, value, meta) {
			...
			images_upload_handler: function (blobInfo, success, failure) {
				...
				xhr.open('POST', '/images/articles/{{$article->id}}/upload');
